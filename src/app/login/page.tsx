  ...
  return (
    ...
    >
        <form action={formAction} noValidate>
          <AuthField inputRef={emailRef} id="email" label="Email" name="email" type="email" autoComplete="username" autoFocus={state.focus === 'email'} aria-invalid={state.field === 'email'} aria-describedby={state.error ? 'login-error' : undefined} />
          <AuthField inputRef={passwordRef} id="password" label="Password" name="password" type="password" autoComplete="current-password" autoFocus={state.focus === 'password'} aria-invalid={state.field === 'password'} aria-describedby={state.error ? 'login-error' : undefined} />
